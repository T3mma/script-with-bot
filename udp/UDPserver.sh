...
idioam_lang() {
  source <(curl -sSl 'https://raw.githubusercontent.com/T3mma/script-with-bot/main/udp/lang')
  ...
  for arch in $listarq; do
    if ! wget -O $lang_dir/${list_lang[$lg]}/$arch "https://raw.githubusercontent.com/T3mma/script-with-bot/main/udp/${list_lang[$lg]}/$arch" &>/dev/null; then
...
if [[ ! -e $udp_file/UDPserver.sh ]]; then
  ...
  check_sistem
  wget -O $udp_file/module 'https://raw.githubusercontent.com/T3mma/script-with-bot/main/udp/module' &>/dev/null
  chmod +x $udp_file/module
  #source $udp_file/module
  wget -O $udp_file/limitador.sh "https://raw.githubusercontent.com/T3mma/script-with-bot/main/udp/limitador.sh" &>/dev/null
